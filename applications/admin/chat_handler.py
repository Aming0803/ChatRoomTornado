...
from common.chat_tool import ChatManager, MultPersonChatManger
import datetime
import json
...
class OneToOneChaHandler(BaseHandler):
    ...
    def get(self):
        ...
        return self.render('single_chat.html', cur_user=cur_user, to_user=to_user)
...
class ChatOneToOneBySocketHandler(WebSocketHandler):
    ...
    def send_to_update(self, waits, chat):
        html_info = to_basestring(self.render_string("ajax/message.html", data=chat))
        for wait in waits:
